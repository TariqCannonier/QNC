...
for k in quanta:
    P[k] = (math.factorial(10)/(math.factorial(k)*math.factorial(10-k)))*(0.2**k)*((1-0.2)**(10-k))
print('Exercise1:\n')
print(P)
...
for r in release_probability:
    P.append((math.factorial(10)/(math.factorial(k)*math.factorial(10-k)))*(r**k)*((1-r)**(10-k)))
print("\nExercise2:")
print(P)
...
for r in release_probability:
    prob['p5'].append((math.factorial(10)/(math.factorial(5)*math.factorial(10-5)))*(r**5)*((1-r)**(10-5)))
    prob['p8'].append((math.factorial(10)/(math.factorial(8)*math.factorial(10-8)))*(r**8)*((1-r)**(10-8)))
